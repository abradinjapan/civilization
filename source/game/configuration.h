#ifndef CIV__configuration
#define CIV__configuration
...
void CONF2__setup__game(GAME__information* game_information, GENERATION__seed seed) {
    ...
    // open world manager
    (*game_information).p_world_manager = MANAGER__open__world_manager(&CONF2__generate_chunks__flat_world, ESS__create__dimensions(7, 7, 7), camera_position, GENERATION__open__blueprint(seed));
